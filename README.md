...
|**beforeCall**|(call) => void | Promise | event hook to execute a function before a rpc is called. This is setup on a per-sevice basis|
|**afterCall**|(call) => void | Promise | event hook to execute a function after a rpc is called. This is setup on a per-sevice basis|
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODY2ODk2MTEwXX0=
-->